...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].App.addListener('appStateChange', this.checkAuthOnResume.bind(this));
    };
    ...
    AppComponent.prototype.ngOnDestroy = function () {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].App.removeListener('appStateChange', this.checkAuthOnResume);
    };
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"]],
            providers: [
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canLoad = function (route, segments) {
        var _this = this;
        return this.authService.userIsAuthenticated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (isAuthenticated) {
            if (!isAuthenticated) {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (isAuthenticated) {
            if (!isAuthenticated) {
                _this.router.navigateByUrl('/auth');
            }
        }));
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var AuthService = /** @class */ (function () {
    ...
    Object.defineProperty(AuthService.prototype, "userIsAuthenticated", {
        get: function () {
            return this._user.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (user) {
                if (user) {
                    return !!user.token;
                }
                else {
    ...
    AuthService.prototype.autoLogin = function () {
        var _this = this;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(_capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"].Storage.get({ key: 'authData' })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (storedData) {
            ...
            var user = new _user_model__WEBPACK_IMPORTED_MODULE_6__["User"](parsedData.userId, parsedData.email, parsedData.token, expirationTime);
            return user;
    ...
    AuthService.prototype.signup = function (email, password) {
        return this.http
            .post("https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=" + _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].firebaseAPIKey, { email: email, password: password, returnSecureToken: true })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(this.setUserData.bind(this)));
    };
    AuthService.prototype.login = function (email, password) {
        return this.http
            .post("https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=" + _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].firebaseAPIKey, { email: email, password: password, returnSecureToken: true })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(this.setUserData.bind(this)));
    };
    AuthService.prototype.logout = function () {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"].Storage.remove({ key: 'authData' });
    };
    ...
    AuthService.prototype.setUserData = function (userData) {
        ...
        var user = new _user_model__WEBPACK_IMPORTED_MODULE_6__["User"](userData.localId, userData.email, userData.idToken, expirationTime);
    ...
    AuthService.prototype.storeAuthData = function (userId, token, tokenExpirationDate, email) {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"].Storage.set({ key: 'authData', value: data });
    };
...
var environment = {
    production: false,
    googleMapsAPIKey: 'AIzaSyA6VwHxAxoI888ncbRSi5A6o45WhgiYc_g',
    firebaseAPIKey: 'AIzaSyBfKNyZZQhMmqwAWsYl4alTDB3HM221OSQ'
};
/*
...
/* harmony import */ var _ionic_pwa_elements__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/pwa-elements */ "./node_modules/@ionic/pwa-elements/dist/index.mjs");
...
module.exports = __webpack_require__(/*! H:\Coding\Ionic\Pair BnB\src\main.ts */"./src/main.ts");
