...
/* harmony import */ var _booking_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./booking.model */ "./src/app/bookings/booking.model.ts");
...
var BookingService = /** @class */ (function () {
    ...
    BookingService.prototype.addBooking = function (placeId, placeTitle, placeImage, firstName, lastName, guestNumber, dateFrom, dateTo) {
        ...
        return this.authService.userId.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (userId) {
            ...
            newBooking = new _booking_model__WEBPACK_IMPORTED_MODULE_4__["Booking"](Math.random().toString(), placeId, fetchedUserId, placeTitle, placeImage, firstName, lastName, guestNumber, dateFrom, dateTo);
            return _this.http.post("https://ionic-pairbnb-bc44b.firebaseio.com/bookings.json?auth=" + token, __assign({}, newBooking, { id: null }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (resData) {
            generatedId = resData.name;
            return _this.bookings;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (bookings) {
    ...
    BookingService.prototype.cancelBooking = function (bookingId) {
        ...
        return this.authService.token.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (token) {
            return _this.http.delete("https://ionic-pairbnb-bc44b.firebaseio.com/bookings/" + bookingId + ".json?auth=" + token);
    ...
    BookingService.prototype.fetchBookings = function () {
        ...
        return this.authService.userId.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (userId) {
            ...
            return _this.http.get("https://ionic-pairbnb-bc44b.firebaseio.com/bookings.json?orderBy=\"userId\"&equalTo=\"" + fetchedUserId + "\"&auth=" + token);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (bookingData) {
            var bookings = [];
            for (var key in bookingData) {
                if (bookingData.hasOwnProperty(key)) {
                    bookings.push(new _booking_model__WEBPACK_IMPORTED_MODULE_4__["Booking"](key, bookingData[key].placeId, bookingData[key].userId, bookingData[key].placeTitle, bookingData[key].placeImage, bookingData[key].firstName, bookingData[key].lastName, bookingData[key].guestNumber, new Date(bookingData[key].bookedFrom), new Date(bookingData[key].bookedTo)));
                }
            }
            return bookings;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (bookings) {
